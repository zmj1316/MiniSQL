...
//	int size_u8;// size: int&float->4 str->0~255
//};
...
//	column col[32];// columns
//	int colNum_u64;// column number
//	int primarykey_u8;// Primary key
//	int buf;// the buffer 
//	int recordSize;// The size of one piece of record
//	int recordNum;// number of records
//};
...
//enum Compare
//{
//	LT, LE, EQ, GE, GT, NE // Compare type
//};
//typedef enum Compare Compare;
//
//struct Rule
//{
//	int colNo;// compare source index
...
//
//bool miniSQL_open(const char *)
//{
//	return true;
//}
//
//bool miniSQL_createTable(table *tab)
//{
//	cout << "tableName:" << tab->name_str << endl;
//	cout << "tableNum:" << tab->colNum_u64 << endl;
//	cout << "recordNum:" << tab->recordNum << endl;
//	cout << "recordSize:" << tab->recordSize << endl;
//	for (int i = 0; i < tab->colNum_u64; i++)
//		cout << "col[" << i << "]: name = " << tab->col[i].name_str << " type = " << tab->col[i].type << " uniq = " << tab->col[i].unique_u8 << " size = " << tab->col[i].size_u8 << "*" << endl;
//
//	return true;
//}
//
//table *miniSQL_connectTable(string)
//{
//	return NULL;
//}
//
//bool miniSQL_dropTable(table *tab)
//{
//	return true;
//}
//
//vector<record> miniSQL_select(table*, Filter *)
//{
//	vector<record> vct;
//	return vct;
//}
//
//bool miniSQL_insert(table *, record *)
//{
//	return true;
//}
//
//int miniSQL_delete(table *, Filter *)
//{
//	return 1;
//}
//
//void miniSQL_disconnectTable(table *)
//{
//
//}
//
//bool miniSQL_createIndex(table *p, string idx, string col)
//{
//	return true;
//}
//
//bool miniSQL_dropIndex(string idx)
//{
//	return true;
//}
...
void create_table()
{
	if (miniSQL_connectTable(sql[2].c_str()) == NULL)
	{
		...
		while (sql[k] != "primary")
		{
			...
			{
				tab.col[i].type = CHAR;
				tab.col[i].size_u8 = todigit(sql[k + 1].substr(5, sql[k + 1].length() - 6));
			}
	...
	if (sql[1] == "*")
		if (sql[2] == "from")
		{
			...
			if (sql[3].find_first_of(';') > -1)
			{
				...
				{
					Filter f;
					vector<record> r = miniSQL_select(p, &f);
					if (r.size() == 0)
					{
					...
					{
						int i;
						for (i = 0; i < p->colNum_u64; i++)
						{
							cout << p->col[i].name_str << " ";
						}
						for (i = 0; i < r.size(); i++)
						{
							for (int j = 0; j < p->colNum_u64; j++)
							{
								cout << p->colNum_u64 << " ";
							}
							cout << endl;
